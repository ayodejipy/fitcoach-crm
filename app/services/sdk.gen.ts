 ...
 */
export const getApiV1Integrations = <ThrowOnError extends boolean = true>(options?: Options<GetApiV1IntegrationsData, ThrowOnError>) => (options?.client ?? client).get<GetApiV1IntegrationsResponses, GetApiV1IntegrationsErrors, ThrowOnError, 'data'>({
    responseStyle: 'data',
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 */
export const deleteApiV1IntegrationsGoogle = <ThrowOnError extends boolean = true>(options?: Options<DeleteApiV1IntegrationsGoogleData, ThrowOnError>) => (options?.client ?? client).delete<DeleteApiV1IntegrationsGoogleResponses, DeleteApiV1IntegrationsGoogleErrors, ThrowOnError, 'data'>({
    responseStyle: 'data',
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 */
export const getApiV1IntegrationsGoogleCallback = <ThrowOnError extends boolean = true>(options: Options<GetApiV1IntegrationsGoogleCallbackData, ThrowOnError>) => (options.client ?? client).get<unknown, GetApiV1IntegrationsGoogleCallbackErrors, ThrowOnError, 'data'>({
    responseStyle: 'data',
...
/**
 * Start Google Calendar OAuth (returns the consent URL)
 */
export const postApiV1IntegrationsGoogleStart = <ThrowOnError extends boolean = true>(options?: Options<PostApiV1IntegrationsGoogleStartData, ThrowOnError>) => (options?.client ?? client).post<PostApiV1IntegrationsGoogleStartResponses, PostApiV1IntegrationsGoogleStartErrors, ThrowOnError, 'data'>({
    responseStyle: 'data',
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 */
export const portalConfirmSession = <ThrowOnError extends boolean = true>(options: Options<PortalConfirmSessionData, ThrowOnError>) => (options.client ?? client).patch<PortalConfirmSessionResponses, PortalConfirmSessionErrors, ThrowOnError, 'data'>({
    responseStyle: 'data',
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/api/v1/portal/sessions/{id}',
    ...options,
